        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button asChild variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-squad-primary">
                <a href="https://api.whatsapp.com/send?phone=5585985100928&text=Olá,%20gostaria%20de%20saber%20mais%20sobre%20os%20serviços%20da%20Squad%20Soluções!" target="_blank" rel="noopener noreferrer">
          ...
          <div className="w-full md:w-1/3 flex justify-center">
            <img 
              ...
              className="max-w-xs md:max-w-sm h-auto rounded-lg shadow-lg animate-float"
            />
          </div>
        </div>
      </div>
